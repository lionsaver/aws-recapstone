...
DATABASES = {
    'default': {
        ...
        'HOST': 'database-1.ck9nj5zmmffm.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'lionrecapsblog' # please enter your s3 bucket name
